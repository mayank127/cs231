...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        scores, l2_cache = affine_relu_forward(H1, W2,b2)
        ...
        dH1, grads['W2'], grads['b2'] = affine_relu_backward(dscores, l2_cache)
        _, grads['W1'], grads['b1'] = affine_relu_backward(dH1, l1_cache)
